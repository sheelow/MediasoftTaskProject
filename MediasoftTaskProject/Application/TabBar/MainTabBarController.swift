...
class MainTabBarController: UITabBarController {
    ...
    private func configureTabBar() {
        ...
        tableViewNavigationController.tabBarItem = UITabBarItem(title: "TableView", image: UIImage(systemName: "list.bullet.rectangle"), tag: 0)
        collectionViewNavigationController.tabBarItem = UITabBarItem(title: "Favourites", image: UIImage(systemName: "star"), tag: 1)
